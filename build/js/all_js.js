    ...
    this.each(function () {
      ...
      var d = this,
        ...
        this.items = a(d).parent().children(), this.count = this.items.length - 1, this.index = this.items.index(d), this.navPrev = "", this.navNext = "", this.loaded = !1, this.naturalWidth = 0, this.naturalHeight = 0, this.init = function () {
          ...
          a('<div id="lightboxgallery-modal" class="lightboxgallery-modal-wrapper"><a href="#" class="lightboxgallery-prev"><span></span></a><a href="#" class="lightboxgallery-next"><span></span></a><div class="lightboxgallery-modal"><a href="#" class="lightboxgallery-close lightboxgallery-hidden">&times;</a><div class="lightboxgallery-modal-body"></div></div></div>').appendTo(a("body").addClass("lightboxgallery-modal-open")), this.modal = a("#lightboxgallery-modal"), this.navNext = this.modal.find(".lightboxgallery-next"), this.navPrev = this.modal.find(".lightboxgallery-prev");
        }, this.close = function () {
...
$(function () {
  ...
  var $document = $(document),
      ...
      screenWidth = screen.width; // alert(screenWidth);
  ...
  $galleryItem.length >= imageCount ? $galleryItem.each(function (i, el) {
    i % imageCount === 0 ? $galleryItem.slice(i, i + imageCount).wrapAll(wrap) : "wrap";
  }) : console.log('Less than' + imageCount); //gallery
